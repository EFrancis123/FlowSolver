...
! INSERT your code here to set "fluxi_xmom(i,j)"
      do i=1,ni
        do j=1,nj-1
	  fluxi_xmom(i,j) = fluxi_mass(i,j)*0.5*(vx(i,j)+vx(i,j+1)) + &
...
! INSERT your code here to set "fluxj_xmom(i,j)"
	  fluxj_xmom(i,j) = fluxj_mass(i,j)*0.5*(vx(i,j)+vx(i+1,j)) + &
...
! INSERT your code here to set "fluxi_ymom(i,j)"
      do i=1,ni
        do j=1,nj-1
	  fluxi_ymom(i,j) = fluxi_mass(i,j)*0.5*(vy(i,j)+vy(i,j+1)) + &
...
! INSERT your code here to set "fluxj_ymom(i,j)"
      do i=1,ni-1
        do j=1,nj
	  fluxj_ymom(i,j) = fluxj_mass(i,j)*0.5*(vy(i,j)+vy(i+1,j)) + &
...
! INSERT your code here to set "fluxi_enth(i,j)"
      do i=1,ni
        do j=1,nj-1
	  fluxi_enth(i,j) = fluxi_mass(i,j)*0.5*(hstag(i,j)+hstag(i,j+1))
        end do
      end do
...
! INSERT your code here to set "fluxj_enth(i,j)"
      do i=1,ni-1
        do j=1,nj
	  fluxj_enth(i,j) = fluxj_mass(i,j)*0.5*(hstag(i,j)+hstag(i+1,j))
        end do
      end do
